...
Source0  : https://files.pythonhosted.org/packages/9f/86/fd7f58fc498b3166f3a7e8e0cddb6e620fe1da35b02248b1bd59e95dbaaa/cssselect2-0.8.0.tar.gz
...
%prep
%setup -q -n cssselect2-0.8.0
cd %{_builddir}/cssselect2-0.8.0
pushd ..
cp -a cssselect2-0.8.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1741231419
